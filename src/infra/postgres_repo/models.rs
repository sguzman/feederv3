//! Row structs and conversions between SQLx records and domain types for Postgres.
...
pub struct StateRowRecord {
    pub feed_id: String,
    pub phase: String,
    pub last_head_at: Option<DateTime<Utc>>,
...
impl From<StateRowRecord> for StateRow {
    fn from(value: StateRowRecord) -> Self {
        Self {
            ...
            phase: value.phase,
            last_head_at_ms: super::util::ms_from_ts(value.last_head_at),
            last_head_status: value.last_head_status,
            last_head_error: value.last_head_error,
            last_get_at_ms: super::util::ms_from_ts(value.last_get_at),
            last_get_status: value.last_get_status,
            last_get_error: value.last_get_error,
            etag: value.etag,
            last_modified_ms: super::util::ms_from_ts(value.last_modified_at),
